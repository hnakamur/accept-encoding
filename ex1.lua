...
local res1 = accept_encoding.match_encoding(header_value, "gzip")
print(string.format("res1 type=%s, q=%s", res1.match_type, res1.q))

local res2 = accept_encoding.match_encoding(header_value, "br")
print(string.format("res2 type=%s, q=%s", res2.match_type, res2.q))

local better = accept_encoding.is_better_encoding_match(res1, res2)
...
better = accept_encoding.is_better_encoding_match(res2, res3)
print(string.format("better=%s", better))
